...
# Plotting Tree
plot.phylo(pruned_tree_overall, type = "fan", no.margin = T, show.tip.label = F, edge.width = 0.2, cex = 0.5, edge.color = "gray50")
tiplabels(pch = 20, col = c("gray95", "lighcoral")[as.factor(pruned_data_overall$sc)], lwd = 5)
nodelabels(pie = tworate_sc$lik.anc, piecol = setNames(c("whitesmoke", "lightcoral"), c(0,1)), cex = 0.2)

##### OVERALL NON-IRIDESCENT STRUCTURAL COLORATION #####
...
nodelabels(pie = tworate_nisc$lik.anc, piecol = setNames(c("whitesmoke", "lightcoral"), c(0,1)), cex = 0.2)

##### BLUE NON-IRIDESCENT STRUCTURAL COLORATION #####
...
##### GREEN NON-IRIDESCENT STRUCTURAL COLORATION #####
...
##### PURPLE NON-IRIDESCENT STRUCTURAL COLORATION #####
